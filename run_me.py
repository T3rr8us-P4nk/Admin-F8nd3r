...
\033[96m
+=========================================+
|.........BASIC ADMIN WEB FINDER .........|
+-----------------------------------------+
|#Created By:     T3rr8us P74NK           |
...
+-----------------------------------------+
''')
print("\033[1;31;40mGo To GitHub And Find This Tool And Read The Instructions There")
print("                                                                       ")
url = input("\033[1;35;40m[+] \033[1;32;40mEnter Website Link : ")
print(" ")
print(" ")
time.sleep(2)
Writertext("[x] Please Wait...")
time.sleep(3)
os.system("clear")
print(" ")
...
for hani in passe :
    ...
    try :
        ...
        print("\033[1;32;40m[+]Admin Page Found ::: "+curl)
        
    except urllib.error.URLError as msg :
        print ("\033[91m[+]Admin Not Found ::: "+curl)
